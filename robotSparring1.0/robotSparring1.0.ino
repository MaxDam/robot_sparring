...
unsigned long shotDuration = 500;
unsigned long shotPause    = 1000;

//right degree calibration
unsigned int right_zero_degree           = 20;
unsigned int right_straight_degree       = 90;
unsigned int right_hook_degree           = 190;
unsigned int right_shoulder_zero_degree  = 10;
unsigned int right_shoulder_degree       = 100;
//left degree calibration
unsigned int left_zero_degree            = 20;
unsigned int left_straight_degree        = 80;
unsigned int left_hook_degree            = 110;
unsigned int left_shoulder_zero_degree   = 0;
unsigned int left_shoulder_degree        = 90;
...
void startPosition() {
	pwm.setPWM(RIGHT_ARM, 0, angleToPulse(right_zero_degree));
	pwm.setPWM(LEFT_ARM, 0, angleToPulse(left_zero_degree));
...
void straightRight() {
  displayText("straight right");
	//pwm.setPWM(RIGHT_ARM, 0, angleToPulse(right_straight_degree));
	pwm.setPWM(RIGHT_SHOULDER, 0, angleToPulse(right_shoulder_degree));
	pwm.setPWM(RIGHT_ARM, 0, angleToPulse(right_straight_degree));
	delay(shotDuration);
	pwm.setPWM(RIGHT_ARM, 0, angleToPulse(right_zero_degree));
	pwm.setPWM(RIGHT_SHOULDER, 0, angleToPulse(45));
...
void straightLeft() {
  ...
  //pwm.setPWM(LEFT_ARM, 0, angleToPulse(left_straight_degree));
  pwm.setPWM(LEFT_SHOULDER, 0, angleToPulse(left_shoulder_degree));
  pwm.setPWM(LEFT_ARM, 0, angleToPulse(left_straight_degree));
  delay(shotDuration);
  pwm.setPWM(LEFT_ARM, 0, angleToPulse(left_zero_degree));
  pwm.setPWM(LEFT_SHOULDER, 0, angleToPulse(45));
...
void hookRight() {
  displayText("hook right");
	//pwm.setPWM(RIGHT_ARM, 0, angleToPulse(right_hook_degree));
	pwm.setPWM(RIGHT_SHOULDER, 0, angleToPulse(right_shoulder_zero_degree));
	pwm.setPWM(RIGHT_ARM, 0, angleToPulse(right_hook_degree));
	delay(shotDuration);
	pwm.setPWM(RIGHT_ARM, 0, angleToPulse(right_zero_degree));
	pwm.setPWM(RIGHT_SHOULDER, 0, angleToPulse(45));
...
void hookLeft() {
  displayText("hook left");
	//pwm.setPWM(LEFT_ARM, 0, angleToPulse(left_hook_degree));
	pwm.setPWM(LEFT_SHOULDER, 0, angleToPulse(right_shoulder_zero_degree));
	pwm.setPWM(LEFT_ARM, 0, angleToPulse(left_hook_degree));
	delay(shotDuration);
	pwm.setPWM(LEFT_ARM, 0, angleToPulse(left_zero_degree));
	pwm.setPWM(LEFT_SHOULDER, 0, angleToPulse(45));
