...
<body>
  ...
  <div class="tabs">
    ...
    <button class="tab-btn"        onclick="showTab(3)">Servo config</button>
  </div>
  ...
  <script>
    ...
    function setStartDegree(val) {
      ...
      fetch('/setStartDegree?val=' + val); 
    }
    function setEndDegree(val) {
      document.getElementById("endDegreeValue").innerText = val;
      fetch('/setEndDegree?val=' + val); 
    }
