...
<body>
  ...
  <div id="tab1" class="tab-content" style="display:none;">
    ...
    <div style="margin-top:30px;">
      ...
      <input type="range" id="delaySlider" min="200" max="600" value="350" oninput="setDelay(this.value)"/>
      <span id="delayValue" class="slider-value">350</span>
    </div>
  </div>
